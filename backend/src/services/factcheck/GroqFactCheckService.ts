...
2. When SOURCE DOCUMENTS are provided, verify claims AGAINST those specific documents first.
3. For claims not covered by source documents, evaluate using your own knowledge.
...
- If source documents were provided, cite which source supports or contradicts the claim
...
Please analyze the factual accuracy of the AI response above.${sourceContent && sourceContent.length > 0
